...
// 자바는 내부적으로 여러개의 같은 데이터타입의 객체들을 한꺼번에 모아서
// 제어할 수 있는 "Collection" 이라는 개념이 존재한다.
// 이 콜렉션에 해당하는 클래스들은 모두 공통적으로 "동적 할당"이 구현되어있다.
...
public class Ex01ArrayList {
    ...
    public static void main(String[] args) {
        ...
        // String 객체들이 모여있을 ArrayList객체 list
        ArrayList<String> list = new ArrayList<>();
        
        // 이번 예제에서 사용할 String객체를 5개 선언과 초기화 해보자
        String str1 = "abc";
        ...
        // 1. ArrayList 객체의 크기를 확인할때에는 size()를 사용한다.
        System.out.println("1.size()");
        System.out.println("list.size(): "+ list.size());
        System.out.println("---------------------------\n");
   
        // 2. 현재 ArrayList의 객체가 비어있는지 확인할 대에는 isEmpty()를 사용한다.
        ...
        // 4. 특정 인덱스에 저장된 객체를 불러올 땐 get(인덱스) 로 불러온다.
        ...
        // 5. ArrayList 객체의 특정 인덱스에 새로운 값을 끼워넣으려면
        //    add(인덱스, 객체)를 사용한다.
        System.out.println("5,add(인덱스, 객체)");
        System.out.println("add(인덱스, 객체) 전 list.get(1): " + list.get(1));
        list.add(1,"가나다");
        System.out.println("add(인덱스, 객체) 후 list.get(1): " + list.get(1));
        System.out.println("----------------------------\n");
        ...
        System.out.println("set() 후 lsit.get(0)" + list.get(0));
        System.out.println("원래 0번 인덱스에 있던 객체 : " + temp);
        System.out.println("---------------------------\n");
        
        // 7. ArrayList 객체 안에 저장된 값을 모두 날릴 때에는
        //    clear()를 사용한다.
        ...
        // 여기서부터 알려드릴 메소드들은 모두 다 템플릿 클래스 안에
        // equals() 가 오버라이드가 되어있어야 정상적으로 작동하는 메소드들이다.
        // 8. 특정 객체가 ArrayList 객체에 존재하는지 찾을 때에는 contains(객체) 를 사용한ㄴ다.
        ...
        System.out.println("list.iof(str1): " + list.indexOf(str1));
        System.out.println("list.iof(ㅋㅋㅋ): " + list.indexOf("ㅋㅋㅋ"));
        System.out.println("list.iof(str5):" + list.indexOf(str5));
        ...
        //     만약 해당객체가 존재하지 않으면 -1이 리턴된다.
        System.out.println("10. lastindexof(객체)");
        ...
        // 12. 특정 객체를 ArrayList 객체에서 삭제할때에는
        // remove(객체) 를 사용한다.
        System.out.println("12. remove(객체)");
        System.out.println("remove(str4)전 list.contains(str3)" + list.contains(str3));
        list.remove(str4);
        System.out.println("remove(str4)후 list.contains(str3)" + list.contains(str3));
