...
public class Ex02Lotto {
    ...
    public static void main(String[] args) {
        ...
        // ArrayList 객체의 정렬을 손쉽게 할 수있다.
        Collections.sort(list);
        // list의 내용을 출력한다.
        // 만약 우리가 콜렉션에 해당하는 클래스객체를 단순히 출력만 할 때에는
        ...
        // 지금 현재 우리의 ArrayList 객체인 list를 기준으로해서
        // for문형태와 forEach문형태로 적으면 각각 다음과 같다.
