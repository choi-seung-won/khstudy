...
// DateTime은 1970년 1월1일 그리니치 표준 시간대 0시 0분 0초를 기준으로 하여
// 목표시간을 1000분의 1초로 나타내는 방법이었다.
// 하지만, 이제는 우리가 DateTime보다는
// Calendar 라는 클래스를 사용하여 시간을 저장하게 되었다.

// 또한, 시간을 출력할 때에는
// 우리가 SimpleDateFormat이란느 것을 사용하게 되었다.
...
public class Ex01Time {
    ...
    public static void main(String[] args) {
        ...
        // sysout.print(),printf(),println() 에 객체를 파라미터로 넘겨주면
        // 해당 객체의 toString() 메소드가 실행되서 리턴된 String값이 결과로 출력된다.
        // Calendar의 경우 각필드의 값이 출력되도록 toString()이 정의되어있다.
        System.out.println(cal);
        
        // Calendar 객체의 값을 좀 예쁘게 출력하고 싶다면.
        // 우리가 SimpleDateFormat 이란느 클래스의 객체를 사용해서
        // Calendar 객체의 getTime() 메소드의 결과값을 예쁘게 조정해서 출력하라는 식으로
        // 코드를 작성해야한다.
        ...
        // ####년 #월 #일 ##시 #분 #초ㅢ 형식으로 출력되게 SimpleDateFormat을 초기화해보자
        ...
        // 4. 특정 필드만 수정
        // set(calendar의 상수, 바꿀 값
        cal.set(Calendar.DAY_OF_MONTH, 20);
        System.out.println(sdf.format(cal.getTime()));
        
        // 5. 만약 set을 사용해서 잘못된값(ex:50일)등을넣으면?
