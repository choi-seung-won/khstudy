...
// 그리고 메소드들 중에서 외부가 사용할것이 아니면 전부 다 볼 수 없게 설정하는 것이다.

// 즉, 우리의 클래스의 특정 메소드를 사용할려면, 메소드만 따로 불러와서 사용하는 것이 아니라
// 해당 클래스 객체를 통째로 만들어야 사용할 수 있게 만드는 것이다.

// 이 캡슐화와 데이터 은닉화에서 중요해지는것이 바로
// "private" 접근제한자이다.

// private 접근 제한자가 걸려있는 필드에 값을 저장하거나 저장된 값을 불러올 때에는
// 우리가 직접적으로 객체이름.필드이름 으로 접근하는것이 아니라
...
// public void set 필드이름(필드와 같은 파라미터){
//        this.필드이름 = 파라미터;
// }
...
public class Ex03Encapsulation {
    ...
    public static void main(String[] args) {
        ...
        // Student2 클래스 객체를 만들어서 각각의 필드에 값을 넣고 출력해보자
        
        Student2 s2 = new Student2();
        // s2.id = 3; -> 해당 필드는 private 접근제한자가 걸려있으므로 직접접근 불가능.
        s2.setId(3);
        s2.setName("조재영");
