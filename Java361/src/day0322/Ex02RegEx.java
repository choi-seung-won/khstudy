...
// 예를 들어서
// 숫자의 경우에는
// 시작부터 끝까지 0부터 9가 1개 이상으로 이루어진것 이라고 표현 가능하다.

// 핸드폰 번호(010 기준)은 다음과 같이 표현 가능하다
// 010-1~9로 시작하는 4자리숫자-1~9로 시작하는 4자리숫자
...
public class Ex02RegEx {
    ...
    public static void main(String[] args) {
        ...
        // 우리가 지정한 글자의 종류가 총 몇번 나올지도 직접 지정해줄 수 있다.
        // *: 1번이상
        // +: 0번이상
        // {X}: X번 이상
        pattern = "^[A-z]*$";
        ...
        // 해당 String 값이 숫자로만 이루어져 있는지 체크하는 정규표현식
        // 단, 자릿수는 0자리 이상
        ...
        // 2. 이메일 주소는 첫글자를 제외한 앞 부분이 알파벳과 숫자로 이루어져 있다.
        // 3. 이메일 주소 앞부분이 끝나면 @ 가 나온다.
        // 4. 이메일 주소 뒷부분은 맨 첫글자가 알파벳으로 시작한다.
        // 5. 뒷부분의 첫 파트는 알파벳과 숫자로 이루어져 있다.
        ...
        System.out.println("bc@aa..".matches(pattern));
