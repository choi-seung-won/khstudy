...
// java.lang.Object를 상속받아서 그 안에 equals(), 생성자,toString()등의메소드를
// 사용할 수 있다.

// 하지만 우리가 직접 상속을할려고 하면 어떻게 해야할까?
// 또 , 상속에는 어떤 종류가 있을까?

// 클래스 상속: 클래스 상속이 우리가 일반적으로 말하는 상속으로써
// 코드의 재사용성을 높여주는 방법이다.
// 클래스 상속은 우리가 클래스 선언이 끝나고 {} 시작전에 extends"상속할 클래스이름" 을 적어서
// 상속을 하게 된다.

// 인터페이스 상속: 인터페이스 상속은 코드의 재사용성이 아닌, 객체의 "다형성" 이라는 성격을 부여해주기위해
// 하는 상속이다.
