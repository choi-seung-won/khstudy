...
// 따라서 우리는 컨트롤러 안에 ArrayList 필드를 사용하여
...
public class StudentController {
    ...
    // 다음 추가할 학생의 학생번호를 저장한 int 변수
    private int nextId;

    public StudentController() {
        // 생성자에서 ArrayList 필드의 초기화를 해준다.
        list = new ArrayList<>();
        nextId = 1;
    ...
    // 5. 파라미터로 들어온 int값과 일치하는 StudentDTO 객체를
    // 삭제하는 delete()
