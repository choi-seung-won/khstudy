...
public class Ex11Print {
    ...
    public static void main(String[] args) {
        ...
        // println()은 "print a line" 의 줄임말으로써
        // 괄호 안의 내용을 출력하고
        ...
        // 4-4. 쌍따옴표
        // 만약 우리가 쌍따옴표를 String 값의 시작 혹은 끝의 의미로 쓰는것이 아니라
        // 문장기호로써의 쌍따옴표를 사용하고 싶다면
        // \" 라고 적어주어야 한다.
        
        System.out.println('\"'+ " \" a");
        System.out.println(" \"so tkwjsdp qnfrksmddms djqtek!\" - skvhffpdhd ");
        // eclipse에서 string값은 파란색으로 출력됨.
        
        // 4-5. 역 슬러시
        // 역 슬러시의 경우, 우리가 문장 기호로 사용되는 것이 아니라
        // 주로 파일 경로로써 사용이 된다.
