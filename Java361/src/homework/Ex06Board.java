...
// Board클래스는 homework 패키지에 만드시면 됩니다.
import java.util.*;
...
public class Ex06Board {
    ...
    // 2. 메뉴를 출력하고 게시글 입력 , 게시글 출력, 프로그램종료
    // 에 따른 메소드 및 코드처리를 할 showMenu()
    ...
    private static void writeBoard() {
        ...
        if(nextIndex < MAX_SIZE) {
            ...
            // 글 번호 자동 배정
            b.setId(nextId++);
            // 사용자 입력시 출력할 메세지를 저장할 String 객체
            String message;
            ...
            System.out.println("더이상 글 작성 불가");
    ...
    private static void printAll() {
        ...
        // 현재 저장된 글이 0 개이면 경고 메시지만 출력하고
        // 그 외에는 글의 번호. 제목의 형식으로 목록을 출력해준다.
        ...
        if(nextIndex == 0) {
            ...
            String message = "상세보기할 게시글의 번호나 뒤로가실려면 0을 입력해주세요.";
    ...
    // 사용자가 입력한 게시글 번호가 존재하면 해당 글의 인덱스를,
