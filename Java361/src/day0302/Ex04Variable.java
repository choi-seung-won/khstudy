...
// 선언은 다음과 같이 한다.
// 데이터타입 변수이름;
// 데이터타입: 해당 변수에 저장 가능한 값의 종류를 지정

// 초기화(Initialization)
// 변수의 초기화란, 해당 변수에 값을 저장하는 것을 우리가 초기화라고 한다
// 값의 할당, 값의 저장 이라고도 표현할 수 있으며 
// 단, 우리가 해당 변수를 사용 하기 위해서는 반드시 최소한 한번은 값이 저장되어야 한다.
// 값의 할당은 다음과 같이 한다.
// 변수이름 = 값;
...
public class Ex04Variable {
    ...
    public static void main(String[] args) {
        ...
        // 2. 똑같은 이름의 변수는 우리가 여러번 선언할 수 없다
        // int 변수 number를 선언하라
        // int number; > 이미 26번라인에서 같은 변수명이 선언됨
        // 같은이름의 number라는 변수는 선언할 수 없다.
        
        number = 80;
        
        // 3. 선언하지 않은 변수에 값을 저장하거나 호출할 수 없다.
        
        // 4. 값을 할당할 때에는 왼쪽엔 무조건 공간을, 오른쪽엔 저장할 값을 적어야한다.
        // 3 = number;
